...
# Usage: curl -sL https://raw.githubusercontent.com/Algoraksha/openclaw-android/main/bootstrap.sh | bash
set -euo pipefail

REPO_TARBALL="https://github.com/Algoraksha/openclaw-android/archive/refs/heads/main.tar.gz"
